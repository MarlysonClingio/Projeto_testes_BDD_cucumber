	...
	public NotaAluguel alugar(Filme filme, TipoAluguel tipo) {
		...
		switch (tipo) {
			case COMUM:
				...
				nota.setDataEntrega(DateUtils.obterDataDiferencaDeDias(1));
				nota.setPontuacao(1);
				break;
			case EXTENDIDO:
				nota.setPreco(filme.getAluguel() * 2);
				nota.setDataEntrega(DateUtils.obterDataDiferencaDeDias(3));
				nota.setPontuacao(2);
				break;
			case SEMANAL:
				nota.setPreco(filme.getAluguel() * 3);
				nota.setDataEntrega(DateUtils.obterDataDiferencaDeDias(7));
				nota.setPontuacao(3);
				break;
		}
